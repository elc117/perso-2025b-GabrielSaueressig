...
var $author$project$Frontend$translateGenre = function (genre) {
	switch (genre) {
		case 'Ação':
			return 'Action';
		case 'Aventura':
				...
				var body = $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'generos',
							A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, englishGenres)),
							_Utils_Tuple2(
							'favoritos',
							A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, favIds))
						]));
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Frontend$CloseModal = {$: 6};
var $author$project$Frontend$OpenModal = {$: 7};
var $author$project$Frontend$SendAll = {$: 4};
var $author$project$Frontend$UpdateSearch = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Frontend$ToggleFavorite = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Frontend$viewFavorite = function (movie) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Frontend$viewMovie = function (movie) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
